    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card ">
                ...
                <div class="card-body ">
                    <form class="" method="POST" action="{{route('admin-process-application', $apl)}}"
                    enctype="multipart/form-data" id="submit-process">
                    @csrf
                        <div class="card-body">
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="applied_for" name="applied_for"
                                        value="{{$apl->metas[0]->meta_value}}" readonly>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="applicant_name"
                                            name="applicant_name" value="{{$apl->metas[1]->meta_value}}" readonly>
                                    </div>
                                    <div class="form-group col-md-2">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{$apl->metas[2]->meta_value}}" maxLength="12" readonly>
                                    </div>
                                    <div class="form-group col-md-2">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="email" class="form-control" id="applicant_email"
                                            name="applicant_email" value="{{$apl->metas[5]->meta_value}}" readonly>
                                    </div>
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" maxlength="12"
                                            oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                            class="form-control" id="applicant_tel_mobile" name="applicant_tel_mobile"
                            ...
                            <div class="p-3 mb-2 border rounded border-dark mt-4 bg-light">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="applicant_referee_1_name"
                                            name="applicant_referee_1_name" value="{{$apl->metas[10]->meta_value}}"
                                            readonly>
                                        <label class="float-left mt-2" for="applicant_referee_1_mobile">Tel
                                            No.
                                        </label>
                                        <input type="text" class="form-control" maxlength="12"
                                            id="applicant_referee_1_mobile" name="applicant_referee_1_mobile"
                                            oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                            value="{{$apl->metas[11]->meta_value}}" readonly>
                                        <label class="float-left mt-2" for="applicant_referee_1_occupation">Occupation
                                        </label>
                                        <input type="text" class="form-control" id="applicant_referee_1_occupation"
                                        ...
                                        <input type="text" class="form-control" id="applicant_referee_1_known"
                                            name="applicant_referee_1_known" value="{{$apl->metas[13]->meta_value}}"
                                            readonly>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <h6>
                                        ...
                                        <input type="text" class="form-control" id="applicant_referee_2_name"
                                            name="applicant_referee_2_name" value="{{$apl->metas[14]->meta_value}}"
                                            readonly>
                                        <label class="float-left mt-2" for="applicant_referee_2_mobile">Tel
                                            No.
                                        </label>
                                        <input type="text" class="form-control" maxlength="12"
                                            id="applicant_referee_2_mobile" name="applicant_referee_2_mobile"
                                            oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                            value="{{$apl->metas[15]->meta_value}}" readonly>
                                        <label class="float-left mt-2" for="applicant_referee_2_occupation">Occupation
                                        </label>
                                        <input type="text" class="form-control" id="applicant_referee_2_occupation"
                                        ...
                                        <input type="text" class="form-control" id="applicant_referee_2_known"
                                            name="applicant_referee_2_known" value="{{$apl->metas[17]->meta_value}}"
                                            readonly>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        <label class="float-left" for="applicant_notice_period">Notice
                                            Period</label>
                                        <input type="number" class="form-control" id="applicant_notice_period"
                                            name="applicant_notice_period" value="{{$apl->metas[19]->meta_value}}"
                                            readonly>
                                    </div>
                                    <div class="form-group col-md-3">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea class="form-control" id="applicant_add_info" name="applicant_add_info"
                                            rows="3" value="{{$apl->metas[24]->meta_value}}" readonly></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
