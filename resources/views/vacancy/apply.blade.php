                            ...
                            <div class="row ">
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        @endif
                                        <div class="card-body">
                                            <form class="needs-validation" novalidate method="POST" action="{{route('submit-application', $vacancy)}}" enctype="multipart/form-data" id="submit-application">
                                                @csrf
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <label class="float-left" for="applied_for">Position Applied
                                                            for</label>
                                                        <input type="text" class="form-control" id="applied_for" name="applied_for" value="{{$vacancy->job_title}}" readonly>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <label class="float-left" for="applicant_ic">National ID No. <i class="fa fa-question-circle" data-toggle="popover" title="National ID Guide" data-content="NRIC (MY): 950101XXXXXX <br>                 
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        National ID No. (PH): 1234-5678-9101-1213
                                                                                                                                                                                                                         " data-html="true" data-trigger="focus"></i></label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <label class="float-left" for="resume_applicant">Upload
                                                                Resume</label>
                                                            <input type="file" name="resume_applicant" class="form-control" required>
                                                            <div class="invalid-feedback">
                                                ...
                                                <div class="p-3 mb-2 border rounded border-danger mt-4 bg-light">
                                                    <div class="row text-center">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input class="form-check-input text-center" type="checkbox" value="Yes" id="applicant_conf_info" name="applicant_conf_info" required>
